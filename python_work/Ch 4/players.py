...
players = ['charles', 'martina','michael','florence','eli','robert','david']
...
print(players[-1:])#using a negative pulls the last elements of the list
print(players[0::3])#A third number allows you to skip slice the list
print(players)
